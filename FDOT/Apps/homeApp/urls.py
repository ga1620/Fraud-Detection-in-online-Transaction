...
from .views import userhome,usersignup,userlogin,base,delete_data,upload_data,predict_csv_single,predict_csv_multi,predict_data_manually,view_data,analysis,change_password,login2,account_details,add_files_multi,about,dashboard,userLogout,reports,upload_credit_data,prediction_button,enter_form_data_manually,add_files_single
